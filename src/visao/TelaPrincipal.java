...
public class TelaPrincipal {
    ...
    private void cadastroPedido(int idPedido, ClienteDAO bancoCliente, Scanner scan, PedidoDAO bancoPedido, SaborDAO bancoSabor) {
        Pedido p = new Pedido();
        ...
        bancoPedido.verificaCliente(c, clienteSelecionado);
